 ...
 <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="main" ><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span>HW</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
        	 <ul class="nav navbar-nav navbar-right">
       	 	<li><?php echo $_SESSION["username"]; ?> <span class="glyphicon glyphicon glyphicon-user" aria-hidden="true"></span></li>
            <li><a href="<?= FOLDER_PATH . '/main/logout' ?>"> Salir <span class="glyphicon glyphicon-off" aria-hidden="true"></span></a></li>
            </ul>
        </div>
      </div>
    </nav>
